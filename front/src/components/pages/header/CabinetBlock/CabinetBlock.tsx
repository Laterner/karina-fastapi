...
const CabinetBlock: React.FC<IProps> = ({ auth }) => {
            ...
            <ModalContainer ref={modalRef}>
              {!isRegistation ? (
                <>
                  ...
                  <Button bgcolor={'#ff9a78'} width={100} onClick={() => closeModal()}>
                    Войти
                  </Button>
                  <a href="#" onClick={() => setIsRegistation(true)}>
                    Зарегистрироваться
                  </a>
                </>
              ) : (
                <>
                  ...
                  <Button bgcolor={'#ff9a78'} width={200} onClick={() => closeModal()}>
                    Зарегистрироваться
                  </Button>
                  <a href="#" onClick={() => setIsRegistation(false)}>
                    Войти
                  </a>
                </>
              )}
  ...
  return <div className="cabinet-block">{renderFunction()}</div>
}
